...
to understand the colors of the image. let's go ahead and plot these pixels. since each pixel $$P^{(i)} \belongsto \mathbb{R}^3$$. we are gonna need a 3d plot where each axis represents R , G , B respectively 
